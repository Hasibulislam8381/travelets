<section class="hero container-fluid  overflow-hidden" style="padding-right: 0;padding-left: 0">
    <div class="row g-0 align-items-stretch" style="min-height: 600px;">
        ...
        <div class="hero-left col-md-6 d-flex flex-column justify-content-center p-5">
            <div class="hero-badge mb-3">Women Exploring Bangladesh &amp; Beyond</div>

            <h1 class="hero-title display-4 fw-bold">Explore Fearlessly.</h1>
            <h2 class="hero-subtitle h2 text-muted mb-4">Thrive Together.</h2>

            <p class="hero-desc mb-4">
                A comprehensive women's platform redefining safety, growth, and opportunity in Bangladesh — from travel
                to
                training and secure living. By women, for women.
            </p>
            ...
            <div class="hero-stats d-flex flex-wrap gap-4 mt-auto">
                <div class="stat text-center">
                    <span class="stat-value d-block fw-bold h4 mb-0">4,800+</span>
                    <span class="stat-label small">Women Served</span>
                </div>
                <div class="stat text-center">
                    <span class="stat-value d-block fw-bold h4 mb-0">42+</span>
                    <span class="stat-label small">Destinations</span>
                </div>
                <div class="stat text-center">
                    <span class="stat-value d-block fw-bold h4 mb-0">14+</span>
                    <span class="stat-label small">Skill Programs</span>
                </div>
            </div>
        </div>
        ...
        <div class="hero-right col-md-6 position-relative">
            <div class="hero-img-placeholder h-100">
                <img src="{{ asset('frontend/images/banner/banner.png') }}" alt="hero" class="hero-main-img" />
            </div>
