                    ...
                    <div class="p-5 card">
                        <div class="card-style mb-30">
                            <div class="mb-3 d-flex justify-content-end">
                                <a href="{{ route('admin.team_member.create') }}" class="btn btn-primary">Add New Member</a>
                            </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.team_member.index') }}",
                        type: "get"
                    },
                    columns: [{
                            data: 'DT_RowIndex',
        ...
        function statusChange(id) {
            let url = '{{ route('admin.team_member.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('admin.team_member.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
                url: url.replace(':id', id),
                headers: {
